...
class LimayracFormation(models.Model):
    ...
    Question1 = fields.Text(string='Question 1')
    Question2 = fields.Text(string='Question 2')
    Question3 = fields.Text(string='Question 3')
    Question4 = fields.Text(string='Question 4')
    Question5 = fields.Text(string='Question 5')
